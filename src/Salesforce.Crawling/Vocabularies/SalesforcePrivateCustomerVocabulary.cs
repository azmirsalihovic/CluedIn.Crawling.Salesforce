...
namespace CluedIn.Crawling.Salesforce.Vocabularies
{
    ...
    public class SalesforcePrivateCustomerVocabulary : SimpleVocabulary
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesforceAccountVocabulary"/> class.
        /// </summary>
        public SalesforcePrivateCustomerVocabulary()
        {
            VocabularyName = "Salesforce Private Customer";
            KeyPrefix      = "salesforce.privatecustomer";
            KeySeparator   = ".";
            Grouping       = EntityType.Infrastructure.User;
            

            AddGroup("Salesforce Private Customer Details", group =>
            {
                ...
                Phone = group.Add(new VocabularyKey("phone", VocabularyKeyDataType.PhoneNumber, VocabularyKeyVisibility.Visible).WithDisplayName("Account Phone"));
                ...
                AnnualRevenue = group.Add(new VocabularyKey("annualrevenue", VocabularyKeyDataType.Currency, VocabularyKeyVisibility.Visible).WithDisplayName("Annual Revenue").WithDescription("\"Estimated annual revenue of the account.\""));
                PersonAssistantPhone = group.Add(new VocabularyKey("personassistantphone", VocabularyKeyDataType.PhoneNumber, VocabularyKeyVisibility.Visible).WithDisplayName("Asst. Phone"));
                ...
                BillingState = group.Add(new VocabularyKey("billingstate", VocabularyKeyDataType.GeographyState, VocabularyKeyVisibility.Visible).WithDisplayName("Billing State/Province"));
                BillingStateCode = group.Add(new VocabularyKey("billingstatecode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Billing State/Province Code"));
                ...
                BillingPostalCode = group.Add(new VocabularyKey("billingpostalcode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Billing Zip/Postal Code"));
                PersonBirthDate = group.Add(new VocabularyKey("personbirthdate", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible).WithDisplayName("Birthdate").WithDescription("The birthday of a person - NOT CPR"));
                ...
                PersonDonotCall = group.Add(new VocabularyKey("persondonotcall", VocabularyKeyDataType.Boolean, VocabularyKeyVisibility.Visible).WithDisplayName("Do Not Call"));
                PersonEmail = group.Add(new VocabularyKey("personemail", VocabularyKeyDataType.Email, VocabularyKeyVisibility.Visible).WithDisplayName("Email"));
                PersonEmailBouncedDate = group.Add(new VocabularyKey("personemailbounceddate", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible).WithDisplayName("Email Bounced Date"));
                ...
                PersonHasOptedOutOfEmail = group.Add(new VocabularyKey("personhasoptedoutofemail", VocabularyKeyDataType.Boolean, VocabularyKeyVisibility.Visible).WithDisplayName("Email Opt Out"));
                NumberOfEmployees = group.Add(new VocabularyKey("numberofemployees", VocabularyKeyDataType.Number, VocabularyKeyVisibility.Visible).WithDisplayName("Employees"));
                PersonHasOptedOutOfFax = group.Add(new VocabularyKey("personhasoptedoutoffax", VocabularyKeyDataType.Boolean, VocabularyKeyVisibility.Visible).WithDisplayName("Fax Opt Out"));
                ...
                PersonHomePhone = group.Add(new VocabularyKey("personhomephone", VocabularyKeyDataType.PhoneNumber, VocabularyKeyVisibility.Visible).WithDisplayName("Home Phone"));
                ...
                IsKukCustomerC = group.Add(new VocabularyKey("iskukcustomerC", VocabularyKeyDataType.Boolean, VocabularyKeyVisibility.Visible).WithDisplayName("Is KUK Customer").WithDescription("Is the customer a Kuk Customer "));
                ...
                PersonMailingCity = group.Add(new VocabularyKey("personmailingcity", VocabularyKeyDataType.GeographyCity, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing City"));
                PersonMailingCountry = group.Add(new VocabularyKey("personmailingcountry", VocabularyKeyDataType.GeographyCountry, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing Country"));
                PersonMailingCountryCode = group.Add(new VocabularyKey("personmailingcountrycode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing Country Code"));
                PersonMailingState = group.Add(new VocabularyKey("personmailingstate", VocabularyKeyDataType.GeographyState, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing State/Province"));
                PersonMailingStateCode = group.Add(new VocabularyKey("personmailingstatecode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing State/Province Code"));
                PersonMailingStreet = group.Add(new VocabularyKey("personmailingstreet", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing Street"));
                PersonMailingPostalCode = group.Add(new VocabularyKey("personmailingpostalcode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing Zip/Postal Code"));
                MarketingContactHemKeyC = group.Add(new VocabularyKey("marketingcontacthemkeyC", VocabularyKeyDataType.Identifier, VocabularyKeyVisibility.HiddenInFrontendUI).WithDisplayName("Marketing Contact HEM Key"));
                ...
                PersonOtherAddress = group.Add(new VocabularyKey("personotheraddress", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Other Address").WithDescription("compound address field "));
                PersonOtherCity = group.Add(new VocabularyKey("personothercity", VocabularyKeyDataType.GeographyCity, VocabularyKeyVisibility.Visible).WithDisplayName("Other City"));
                PersonOtherCountry = group.Add(new VocabularyKey("personothercountry", VocabularyKeyDataType.GeographyCountry, VocabularyKeyVisibility.Visible).WithDisplayName("Other Country"));
                PersonOtherCountryCode = group.Add(new VocabularyKey("personothercountrycode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Other Country Code"));
                PersonOtherPhone = group.Add(new VocabularyKey("personotherphone", VocabularyKeyDataType.PhoneNumber, VocabularyKeyVisibility.Visible).WithDisplayName("Other Phone"));
                PersonOtherState = group.Add(new VocabularyKey("personotherstate", VocabularyKeyDataType.GeographyState, VocabularyKeyVisibility.Visible).WithDisplayName("Other State/Province"));
                PersonOtherStateCode = group.Add(new VocabularyKey("personotherstatecode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Other State/Province Code"));
                ...
                PersonOtherPostalCode = group.Add(new VocabularyKey("personotherpostalcode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Other Zip/Postal Code"));
                ...
                ShippingAddress = group.Add(new VocabularyKey("shippingaddress", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Shipping Address"));
                ShippingCity = group.Add(new VocabularyKey("shippingcity", VocabularyKeyDataType.GeographyCity, VocabularyKeyVisibility.Visible).WithDisplayName("Shipping City"));
                ShippingCountry = group.Add(new VocabularyKey("shippingcountry", VocabularyKeyDataType.GeographyCountry, VocabularyKeyVisibility.Visible).WithDisplayName("Shipping Country"));
                ShippingCountryCode = group.Add(new VocabularyKey("shippingcountrycode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Shipping Country Code"));
                ShippingState = group.Add(new VocabularyKey("shippingstate", VocabularyKeyDataType.GeographyState, VocabularyKeyVisibility.Visible).WithDisplayName("Shipping State/Province"));
                ShippingStateCode = group.Add(new VocabularyKey("shippingstatecode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Shipping State/Province Code"));
                ShippingStreet = group.Add(new VocabularyKey("shippingstreet", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Shipping Street"));
                ShippingPostalCode = group.Add(new VocabularyKey("shippingpostalcode", VocabularyKeyDataType.GeographyLocation, VocabularyKeyVisibility.Visible).WithDisplayName("Shipping Zip/Postal Code"));
            ...
            AddMapping(AccountNumber, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.AccountNumber);
            AddMapping(AccountSource, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.AccountSource);
            AddMapping(BillingAddress, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.BillingAddress);
            AddMapping(BillingCity, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.BillingCity);
            AddMapping(BillingCountry, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.BillingCountry);
            AddMapping(BillingCountryCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.BillingCountryCode);
            AddMapping(BillingPostalCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.BillingPostalCode);
            AddMapping(CustomerCityC, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.CustomerCity__c);
            AddMapping(PersonBirthDate, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonBirthdate);
            AddMapping(PersonOtherAddress, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.OtherAddress);
            AddMapping(PersonOtherCity, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.OtherCity);
            AddMapping(PersonOtherCountry, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.OtherCountry);
            AddMapping(PersonOtherCountryCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.OtherCountryCode);
            AddMapping(PersonOtherPhone, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.OtherPhone);
            AddMapping(PersonOtherPostalCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.OtherPostalCode);
            AddMapping(PersonOtherState, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonOtherState);
            AddMapping(PersonOtherStateCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonOtherStateCode);
            AddMapping(PersonOtherStreet, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonOtherStreet);
            AddMapping(PersonHomePhone, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonHomePhone);
            AddMapping(PersonMailingAddress, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.MailingAddress);
            AddMapping(PersonMailingCity, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.MailingCity);
            AddMapping(PersonMailingCountry, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.MailingCountry);
            AddMapping(PersonMailingCountryCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.MailingCountryCode);
            AddMapping(PersonMailingPostalCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.MailingPostalCode);
            AddMapping(PersonMailingState, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonMailingState);
            AddMapping(PersonMailingStateCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonMailingStateCode);
            AddMapping(PersonMailingStreet, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonMailingStreet);
            AddMapping(PersonMobilePhone, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonMobilePhone);
            AddMapping(PersonTitle, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PersonTitle);
            ...
            AddMapping(Phone, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Phone);
            AddMapping(ShippingAddress, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.ShippingAddress);
            AddMapping(ShippingCity, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.ShippingCity);
            AddMapping(ShippingCountry, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.ShippingCountry);
            AddMapping(ShippingCountryCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.ShippingCountryCode);
            AddMapping(ShippingPostalCode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.ShippingPostalCode);
            AddMapping(Type, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Type);
        }
