    ...
    public class SalesforceContactVocabulary : SimpleVocabulary
    {
        ...
        public SalesforceContactVocabulary()
        {
            ...
            AddGroup("Salesforce Contact Details", group =>
            {
                ...
                AssistantName = group.Add(new VocabularyKey("assistantname", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Assistant's Name"));
                AssistantPhone = group.Add(new VocabularyKey("assistantphone", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Asst. Phone"));
                ...
                Fax = group.Add(new VocabularyKey("fax", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Business Fax"));
                Phone = group.Add(new VocabularyKey("phone", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Business Phone"));
                ...
                Description = group.Add(new VocabularyKey("description", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Contact Description"));
                ...
                DoNotCall = group.Add(new VocabularyKey("donotcall", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Do Not Call"));
                ...
                LeadSource = group.Add(new VocabularyKey("leadsource", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Lead Source"));
                ...
                MailingGeocodeAccuracy = group.Add(new VocabularyKey("mailinggeocodeaccuracy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing Geocode Accuracy"));
                MailingLatitude = group.Add(new VocabularyKey("mailinglatitude", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing Latitude"));
                MailingLongitude = group.Add(new VocabularyKey("mailinglongitude", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing Longitude"));
                MailingState = group.Add(new VocabularyKey("mailingstate", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing State/Province"));
                MailingStateCode = group.Add(new VocabularyKey("mailingstatecode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Mailing State/Province Code"));
                ...
                OtherAddress = group.Add(new VocabularyKey("otheraddress", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Other Address"));
                OtherCity = group.Add(new VocabularyKey("othercity", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Other City"));
                OtherCountry = group.Add(new VocabularyKey("othercountry", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Other Country"));
                OtherCountryCode = group.Add(new VocabularyKey("othercountrycode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Other Country Code"));
                OtherPhone = group.Add(new VocabularyKey("otherphone", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Other Phone"));
                OtherState = group.Add(new VocabularyKey("otherstate", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Other State/Province"));
                OtherStateCode = group.Add(new VocabularyKey("otherstatecode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Other State/Province Code"));
                OtherStreet = group.Add(new VocabularyKey("otherstreet", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Other Street"));
                OtherPostalCode = group.Add(new VocabularyKey("otherpostalcode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible).WithDisplayName("Other Zip/Postal Code"));
            ...
            AddMapping(OtherAddress, Semler.Common.Vocabularies.SemlerVocabularies.Contact.AdrLineOther);
            ...
            AddMapping(OtherCity, Semler.Common.Vocabularies.SemlerVocabularies.Contact.CityOther);
            ...
            AddMapping(OtherCountry, Semler.Common.Vocabularies.SemlerVocabularies.Contact.CountryOther);
            AddMapping(MailingCountryCode, Semler.Common.Vocabularies.SemlerVocabularies.Contact.CountryCode);
            AddMapping(OtherCountryCode, Semler.Common.Vocabularies.SemlerVocabularies.Contact.CountryCodeOther);
            ...
            AddMapping(OtherPhone, Semler.Common.Vocabularies.SemlerVocabularies.Contact.PhoneNumOther);
            AddMapping(Phone, Semler.Common.Vocabularies.SemlerVocabularies.Contact.BusinessPhone);
            AddMapping(MailingPostalCode, Semler.Common.Vocabularies.SemlerVocabularies.Contact.PostalCode);
            AddMapping(OtherPostalCode, Semler.Common.Vocabularies.SemlerVocabularies.Contact.PostalCodeOther);
            AddMapping(MailingGeocodeAccuracy, Semler.Common.Vocabularies.SemlerVocabularies.Contact.AdrGeocode);
            AddMapping(MailingLatitude, Semler.Common.Vocabularies.SemlerVocabularies.Contact.AdrLatitude);
            AddMapping(MailingLongitude, Semler.Common.Vocabularies.SemlerVocabularies.Contact.AdrLongitude);
            AddMapping(MailingState, Semler.Common.Vocabularies.SemlerVocabularies.Contact.AdrState);
            AddMapping(MailingStateCode, Semler.Common.Vocabularies.SemlerVocabularies.Contact.AdrStateCode);
            AddMapping(MailingStreet, Semler.Common.Vocabularies.SemlerVocabularies.Contact.AdrLine2);
            AddMapping(OtherState, Semler.Common.Vocabularies.SemlerVocabularies.Contact.OtherState);
            AddMapping(OtherStateCode, Semler.Common.Vocabularies.SemlerVocabularies.Contact.OtherStateCode);
            AddMapping(OtherStreet, Semler.Common.Vocabularies.SemlerVocabularies.Contact.AdrLine2Other);
        }
