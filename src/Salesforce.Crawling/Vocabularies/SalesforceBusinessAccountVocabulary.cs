...
namespace CluedIn.Crawling.Salesforce.Vocabularies
{
    ...
    public class SalesforceBusinessAccountVocabulary : SimpleVocabulary
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesforcePrivateAccountVocabulary"/> class.
        /// </summary>
        public SalesforceBusinessAccountVocabulary()
        {
            VocabularyName = "Salesforce Business Account";
            KeyPrefix = "salesforce.businessaccount";
            KeySeparator = ".";
