...
{
    public class Salesforce_Command_MeshProcessor : BaseMeshProcessor
    {
        public Salesforce_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          SalesforceConstants.ProviderId;
