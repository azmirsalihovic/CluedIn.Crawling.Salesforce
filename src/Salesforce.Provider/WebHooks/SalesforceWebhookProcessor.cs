...
{
    public class SalesforceWebhookProcessor : BaseWebhookProcessor
    {
        public SalesforceWebhookProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }
        ...
        {
            return webhookDefinition.ProviderId == SalesforceConstants.ProviderId || base.Accept(webhookDefinition);
        }
